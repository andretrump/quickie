...
Beim dritten Service der Applikationsschicht, dem \code{MatchingService}, ist die Kohäsion hingegen hoch, da dieser lediglich einen einzigen Use-Case behandelt, nämlich das finden ähnlicher Rezepte. Daher besitzt diese Klasse auch nur die öffentliche Methode \code{getMatchingRecipesFor}. Alle anderen Methoden sind private und beinhalten Teilschritte des Matchingvorgangs.
