...
Beispiele für Klassen, bei denen dieses Prinzip verletzt wurde, sind der \code{ProfileService} und der \code{RecipeService} in der Applikationsschicht, da jede dieser Klassen mehrere Use-Cases implementiert. So implementiert der ProfileService die gesamte Interaktion des Nutzers mit einem Profil vom Anlegen, Bearbeiten und Löschen bis zum Setzen und Entfernen von Opinions.
